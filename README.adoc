...
https://github.com/commoncriteria/servervirtualization/issues[image:https://img.shields.io/github/issues/commoncriteria/servervirtualization.svg?maxAge=2592000[GitHub
issues Open]]

This repository hosts the draft version of the Extended Package for
Server Virtualization based on the
https://commoncriteria.github.io/pp/servervirtualization/servervirtualization-esr.html[Essential
...
can be found https://www.niap-ccevs.org/Profile/Info.cfm?id=410[here].

=== Draft Version

* https://commoncriteria.github.io/pp/servervirtualization/servervirtualization-release.html[PP-Module
for Server Virtualization] (html)
* https://commoncriteria.github.io/pp/servervirtualization/servervirtualization-release.pdf[PP-Module
for Server Virtualization] (pdf)
* https://commoncriteria.github.io/pp/servervirtualization/servervirtualization-sd.html[Supporting
Documents for Server Virtualization] (html)
* https://commoncriteria.github.io/pp/servervirtualization/servervirtualization-sd.pdf[Supporting
Documents for Server Virtualization] (PDF)

=== Release Version

* https://www.niap-ccevs.org/Profile/Info.cfm?id=410[Extended Package
...
https://github.com/commoncriteria/servervirtualization/issues[repository
issue tracker]
